(function(e) {
    ...
    r.p = "//s3.pstatp.com/ies/tiktok_embed/";
    return r(r.s = 0)
})({
    0: function(e, t, r) {
    ...
    "23617503340803072f22": function(e, t, r) {
        ...
        function n(e) {
            for (var t = 1; t < arguments.length; t++) {
                ...
                var n = Object.keys(r);
                if ("function" === typeof Object.getOwnPropertySymbols) n = n.concat(Object.getOwnPropertySymbols(r).filter((function(e) {
        ...
        function u(e, t) {
            ...
            var n = t.data;
            var a = t.success,
                c = void 0 === a ? function e(t, r) {
                    console.log(t)
                } : a,
                i = t.fail,
                o = void 0 === i ? function e(t, r) {
                    console.log("Request was unsuccessful: ".concat(r.status))
                } : i;
            var f = new XMLHttpRequest;
            f.onreadystatechange = function() {
                if (4 === Number(f.readyState))
                    if (f.status >= 200 && f.status < 300 || 304 === f.status) c(f.responseText, f);
                    else o(f.responseText, f)
            };

            function u(e) {
                var t = [];
                if (e instanceof String) e = encodeURIComponent(e);
                else if (e instanceof Object) {
                    Object.keys(e).forEach((function(r) {
                        if (Object.prototype.hasOwnProperty.call(e, r)) t.push("".concat(r, "=").concat(e[r].toString()))
                    }));
        ...
        function s() {
            s = i(regeneratorRuntime.mark((function e(t, r) {
                return regeneratorRuntime.wrap((function e(a) {
                    while (1) switch (a.prev = a.next) {
                        case 0:
                            return a.abrupt("return", new Promise((function(e, a) {
                                var c = n({}, r, {
                                    success: e,
                                    fail: a
                                });
        ...
        function v() {
            ...
            ["error", "log", "info"].forEach((function(e) {
                t[e] = function(t) {
                    if ("info" === e) console[e]("%c".concat(r(t)), "color: #25f4ee");
                    else console[e](r(t))
                }
            }));
            return t
                                            ...
                                            return regeneratorRuntime.wrap((function e(c) {
                                                while (1) switch (c.prev = c.next) {
                                                    ...
                                                    case 2:
                                                        ...
                                                        r = t.libVersion;
                                                        n = void 0 === r ? a["d"] : r;
                                                        return c.abrupt("return", Object(d["e"])() ? a["d"] : n);
                                                    case 6:
                                                    case "end":
                                                        return c.stop()
                                                }
    ...
    "40b8419e3e2132ef0a63": function(e) {
        e.exports = {
            ...
            license: "ISC",
            devDependencies: {
                "@ies/create-eden-config": "^1.0.0",
                "@ies/eden-lint": "^2.12.0"
            },
            dependencies: {
                "core-js": "2.5.7",
                promise: "^8.0.3",
    ...
    "429cfc8e3ed333e40618": function(e, t, r) {
        ...
        e.exports = function(e, t, r, y, m, g, w) {
            ...
            var P = O[s] || O[l] || m && O[m];
            var E = P || x(m);
            var S = m ? !k ? E : x("entries") : void 0;
            var A = "Array" == t ? O.entries || P : P;
            var I, T, R;
            if (A) {
                R = d(A.call(new e));
        ...
        function o(e) {
            ...
            function s(t) {
                if (o[t].logged)
                    ...
                    console.warn("Promise Rejection Handled (id: " + o[t].displayId + "):");
                    console.warn('  This means you can ignore any previous messages of the form "Possible Unhandled Promise Rejection" with id ' + o[t].displayId + ".")
                }
            }
        }
    ...
    e0b8897ffbf48a102fbb: function(e, t, r) {
        ...
        var a = n ? "http://127.0.0.1:9000" : "https://s16.tiktokcdn.com/tiktok/falcon/embed";
        var c = "ttEmbedLibCSS";
        var i = "ttEmbedLibScript";
        var o = "embed_lib_v";
        var f = r("40b8419e3e2132ef0a63").version;
        var u = n ? "http://127.0.0.1:3000" : "https://www.tiktok.com";
        var d = "https://sf-hs-sg.ibytedtos.com/obj/ies-fe-bee-alisg/bee_prod/biz_7/bee_prod_7_bee_publish_835.json";
        var s = "blockquote";
        var v = "tiktokEmbed";
        var l = "tiktok-embed";
        var b = "message";
...
//# sourceMappingURL=embed_v0.0.6.js.map